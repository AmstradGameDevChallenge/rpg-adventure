...
420 IF a$="A" THEN GOSUB 480:GOTO 500
430 IF a$="D" THEN LOCATE 1,4: ?"Player defends!  ":energy=energy+defense:GOTO 500
440 GOTO 400
...
500 ' ENEMY ACTIONS
510 IF RND>0.25 THEN LOCATE 1,4: ?"Enemy attacks!  ":energy=energy-attacken:GOTO 300
520 LOCATE 1,4: ?"Enemy defends!  ":energyen=energyen+defenseen:GOTO 300
...
1085 FOR N=1 TO 40
1086 IF N MOD 2=0 THEN ?CHR$(250); ELSE ?CHR$(251);
1087 NEXT N
1088 ?""
1089 RETURN
